...
import os
import timeit
from diffusers import LMSDiscreteScheduler, DDPMScheduler, AutoencoderKL
    ...
    for niter in range(resume_niters, niters):
       ...
       ############ TRAINING #####################
        ...
        if save_models_folder is not None and ((niter+1) % save_niters_freq == 0 or (niter+1) == niters):
            ...
            save_image(batch_real_images.detach(), 'output/clean_images/CcLDM_clean/{}.png'.format(niter+1), nrow=8, normalize=True)
