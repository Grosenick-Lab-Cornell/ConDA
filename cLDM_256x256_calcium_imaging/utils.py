...
def predict_class_labels(net, images, batch_size=500, verbose=False):
    net = net.cuda()
    net.eval()
    ...
    dataloader_pred = torch.utils.data.DataLoader(dataset_pred, batch_size=batch_size, shuffle=False)
